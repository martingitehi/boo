    ...
    function dirPaginateDirective($compile, $parse, paginationService) {
        ...
        function getRepeatExpression(expression, paginationId) {
            ...
            if (paginationId !== DEFAULT_ID && !idDefinedInFilter) {
                repeatExpression = expression.replace(/(\|\s*itemsPerPage\s*:\s*[^|\s]*)/,
                    "$1 : '" + paginationId + "'");
            } else {
        ...
        function removeTemporaryAttributes(element) {
            ...
            element.eq(0).removeAttr("dir-paginate-start").removeAttr("dir-paginate")
                .removeAttr("data-dir-paginate-start").removeAttr("data-dir-paginate");
    ...
    function dirPaginationControlsDirective(paginationService, paginationTemplate) {
        ...
        function dirPaginationControlsLinkFn(scope, element, attrs) {
            ...
            if (!paginationService.isRegistered(paginationId) && !paginationService.isRegistered(rawId)) {
                ...
                if (window.console) {
                    console.warn("Pagination directive: the pagination controls" +
                        idMessage +
            ...
            function goToPage(num) {
                if (paginationService.isRegistered(paginationId) && isValidPageNumber(num)) {
                    ...
                    scope.pages = generatePagesArray(num,
            ...
            function generatePagination() {
                if (paginationService.isRegistered(paginationId)) {
                    ...
                    scope.pages = generatePagesArray(page,
                        paginationService.getCollectionLength(paginationId),
                        paginationService.getItemsPerPage(paginationId),
                        paginationRange);
